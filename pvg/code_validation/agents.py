...
class OpenAiWholeAgent(PureTextWholeAgent):
    ...
    def build_fine_tune_dataset(
        ...
        rollouts : NestedArrayDict
            ...
            - ("next", "message_history") (... round channel): The history of messages
              exchanged between the agents in each channel.
            - ("next", "message_agent_id") (... round channel): The id of the agent who
              messaged at a round-channel pair.
            - ("next", "raw_message_history") (... round agent): The raw message
...
class OpenAiSharedModelGroup(PureTextSharedModelGroup):
    ...
    def create_supervised_fine_tune_job(
        ...
        fine_tune_datasets: dict[str, list] = {}
